...
class ESC_Service_Templates {
    ...
    public function get_extended_templates() {
        return array(
            ...
            'Monitoring, Analytics & CDN' => array(
                array(
                    'name' => 'Cloudflare CDN',
                ...
                array(
                    'name' => 'StackPath CDN',
                    'url' => 'https://status.stackpath.com/api/v2/status.json',
                    'category' => 'cloud',
                    'method' => 'GET',
                    'expected_code' => '200',
                    'timeout' => 15,
                ...
                array(
                    'name' => 'Splunk Cloud',
                    'url' => 'https://www.splunkstatus.com/api/v2/status.json',
                    'category' => 'custom',
                    'method' => 'GET',
                    'expected_code' => '200',
                    'timeout' => 15,
            ...
            'E-Mail Services' => array(
                ...
                array(
                    'name' => 'SparkPost Status',
                    'url' => 'https://status.sparkpost.com/api/v2/status.json',
                    'category' => 'custom',
                    'method' => 'GET',
                    'expected_code' => '200',
                    'timeout' => 15,
